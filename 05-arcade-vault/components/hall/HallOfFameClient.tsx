    ...
    <div className="av-hall fade-in">
      ...
      {rows.length === 0 ? (
        <div style={{ textAlign: "center", padding: 60, color: "var(--ink-faint)" }}>
          Todavía no hay puntuaciones para {game.title}.
        </div>
      ) : (
        <>
          <div className="podium">
            <div className="podium-slot silver">
              ...
              <div className="score">{(rows[1]?.score ?? 0).toLocaleString("es-ES")}</div>
            ...
            <div className="podium-slot bronze">
              ...
              <div className="score">{(rows[2]?.score ?? 0).toLocaleString("es-ES")}</div>
